...
image_size_input_list=(64 64 64 224 224 96)
image_size_gen_list=(64 64 64 64 64 96)
group_num_list=(6 2 7 15 10 8)
code_dim_list=(80 80 100 100 80 80)
batch_size_list=(64 64 64 32 32 64)
encoder_type_list=("resnet18" "resnet18" "resnet18" "resnet18" "resnet18" "resnet18")
content_decorrelation_weight_list=(2.5e-5 2.5e-5 2.5e-5 8.5e-6 2e-5 2.5e-5)
mask_entropy_weight_list=(3.5e-4 3.5e-4 3.5e-4 5e-6 2e-4 3.5e-4)

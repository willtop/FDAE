...
--model_path logs/2024-09-03-14-10-25-mpi3d_toy_FDAE_seed0_rank0/model040000.pt \
--seed 0 \
--num_samples 5 \
--batch_size 5 \
...
# python conditional_image_sample.py \
# --model_path logs/2024-08-29-16-14-02-mpi3d_toy_FDAE_seed0_rank0/model030000.pt \
